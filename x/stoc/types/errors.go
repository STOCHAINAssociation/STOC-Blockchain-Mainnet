...
var (
	...
	ErrInsufficientFunds    = sdkerrors.Register(ModuleName, 1510, "insufficient funds")
	ErrAmbiguousSymbol      = sdkerrors.Register(ModuleName, 1511, "ambiguous token symbol")
	ErrInvalidAddress       = sdkerrors.Register(ModuleName, 1512, "invalid address")
	ErrInvalidTaxRecipient  = sdkerrors.Register(ModuleName, 1513, "invalid tax recipient address")
)
